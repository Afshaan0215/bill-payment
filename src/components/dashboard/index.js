                            ...
                            <div className="tdl-content">
                              <ul>
                                <li>
                                  <label>
                                    <input type="checkbox" /><i
                                      className="check-box"></i><span>Conveniently fabricate
                                ...
                                <li>
                                  <label>
                                    <input type="checkbox" /><i
                                      className="check-box"></i><span>Creating component
                                        page</span>
                                    <a href='#' className="fa fa-times"></a>
                                    <a href='#' className="fa fa-pencil"></a>
                                    <a href='#' className="fa fa-check"></a>
                                ...
                                <li>
                                  <label>
                                    <input type="checkbox" checked /><i
                                      className="check-box"></i><span>Follow back those who follow
                                        you</span>
                                    <a href='#' className="fa fa-times"></a>
                                    <a href='#' className="fa fa-pencil"></a>
                                    <a href='#' className="fa fa-check"></a>
                                ...
                                <li>
                                  <label>
                                    <input type="checkbox" checked /><i
                                      className="check-box"></i><span>Design One page theme</span>
                                    <a href='#' className="fa fa-times"></a>
                                    <a href='#' className="fa fa-pencil"></a>
                                    <a href='#' className="fa fa-check"></a>
                                  </label>
